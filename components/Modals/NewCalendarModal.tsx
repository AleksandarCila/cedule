        ...
        <>
            {open &&
                <Dialog
                    ...
                    onClose={hideModal}
                >
                    <DialogTitle sx={{ bgcolor: theme.palette.primary.main, color: theme.palette.primary.contrastText }}>{modalState.modalProps.edit ? "Edit Calendar" : "Add a new Calendar"}</DialogTitle>

                    <DialogContent >
                        <IconButton
                            onClick={hideModal}
                            sx={{
                                position: 'absolute', top: 9, right: 10, color: theme.palette.primary.contrastText,
                        ...
                        <FormControl sx={{ px: 2 }}>
                            ...
                            >
                                {calendarColors.map((color, ind) => {
                                    return (
                                        <ColorRadioButton key={ind} ind={ind} value={value} color={color} onClick={(e:any) => { handleChange(e,ind) }} />
                                    )
                                })}
                            </RadioGroup>
                        </FormControl>
